...
export interface FaultyTerminalJSCSSProps extends React.HTMLAttributes<HTMLDivElement> {
  scale?: number
...
export function FaultyTerminalJSCSS({
  scale = 1,
  gridMul = [2, 1],
  digitSize = 1.5,
  timeScale = 0.3,
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      if (!pause) {
        ...
        prog.uniforms.iTime.value = frozenTimeRef.current
      }
      ...
      if (pageLoadAnimation && loadAnimationStartRef.current > 0) {
        ...
        prog.uniforms.uPageLoadProgress.value = progress
      }
      ...
      if (mouseReact) {
        ...
        const mouseUniform = prog.uniforms.uMouse.value as Float32Array
